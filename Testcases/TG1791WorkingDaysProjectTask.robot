...
*** Test Cases ***
LoginTest WorkingDays               lakshminarayanan.radhakrishnan@sqs.com      Ln$$Oct2020
...
LoginTest WorkingDays
    ...
    FOR    ${DailyDate}    IN    @{workingdays}        
        ...
        Select Checkbox    project2   
        Select Checkbox    project4
        Select Checkbox    project7
        Select Checkbox    project8
